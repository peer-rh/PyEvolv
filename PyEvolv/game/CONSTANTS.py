...
N_HIDDEN_UNITS = 30 # The amount of hidden units in a hidden layer of the Net
...
N_CREATURES_PER_SPECIES = 2 # The creatures spawned at the beggining with the same brain and food color and color