RELATIVES_CREATURE_MOVES_PER_STEP = 6 # The maximum amount of relatives (1 tile is 10 relatives) it can move on the x and y axis
...
FOOD_LOST_ON_STEP = 0.05 # The amount of food lost by a creature per step
MAX_FOOD_DIFFERNCE_FOR_NO_LOSS = 0.13 # The Difference betwwen Tile hue and mouth hue, to result in a loss of food for the creature 
...
MIN_WEIGHT_MUTATION = -0.005 # The minimum mutation of the neural network weights
MAX_WEIGHT_MUTATION = 0.005 # The maximum mutation of the neural network weights
N_HIDDEN_UNITS = 30
...
FOOD_LOST_ON_NEW_CHILD = 14 # The amount a creature needs to make a new child
STARTING_FOOD = 8 # The amount of food a creature starts with
FOOD_LOST_ON_WATER = 3 # The amount a creature looses when it walks over water
EVO_STEPS_PER_FRAME = 3 # The amount of steps per frame
NEW_SPECIES_ON_STEPS = True # If random species should be generated each step